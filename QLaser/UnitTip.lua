...
function QLaser.HookSetUnit()
    ...
    if(note ~= nil) then
        ...
        local unitTip = ("|cffffff00--------QDKP ToolTip--------|r\n")

        unitTip = unitTip .. mainColored .. "|cFF40E0D0 [Main] |r" .. (QDKP2online[main] and "|cff00ff00Online|r" or "|cffa6a6a6Offline|r") .. "\n";
        ...
        if QDKP2_LaserAlts[main] ~= nil then
            for alt in pairs(QDKP2_LaserAlts[main]) do
                ...
                if(QDKP2_IsExternal(alt)) then
                    ...
                    unitTip = unitTip .. altColored .. " " .. (QDKP2online[alt] and "|cff00ff00Online|r" or "|cffa6a6a6Offline|r") .. "\n";
                end
            end
        end
