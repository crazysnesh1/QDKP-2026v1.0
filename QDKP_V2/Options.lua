...
QDKP2_Instances = {
    { name = "Naxxramas", DKP_10N = 0, DKP_10H = 0, DKP_25N = 0, DKP_25H = 0 }, -- 1000 total for 10 normal, 2000 for 25 normal
    { name = "Ulduar", DKP_10N = 0, DKP_10H = 0, DKP_25N = 0, DKP_25H = 0 }, -- 1500 total for 10 normal, 3000 for 25 normal
    { name = "Trial of the Crusader", DKP_10N = 0, DKP_10H = 0, DKP_25N = 0, DKP_25H = 0 }, -- 1000 total for 25 heroic
    { name = "Icecrown Citadel", DKP_10N = 0, DKP_10H = 0, DKP_25N = 0, DKP_25H = 0 }, -- 1300 total for 25 normal, 2600 for 25 heroic
    { name = "Ruby Sanctum", DKP_10N = 0, DKP_10H = 0, DKP_25N = 0, DKP_25H = 0 } -- 400 total for 25 normal, 800 for 25 heroic
}
...
QDKP2_Bosses = {
    ...
    -- Ulduar (10 об = 2000 всего, 25 об = 4000 всего)
	{ name = "-------Ulduar-------", DKP_10N = 0, DKP_10H = 0, DKP_25N = 0, DKP_25H = 0 },
    { name = "Flame Leviathan", DKP_10N = 130, DKP_10H = 0, DKP_25N = 270, DKP_25H = 380 },
    { name = "Ignis the Furnace Master", DKP_10N = 130, DKP_10H = 0, DKP_25N = 270, DKP_25H = 0 },
    { name = "Razorscale", DKP_10N = 130, DKP_10H = 0, DKP_25N = 270, DKP_25H = 0 },
    { name = "XT-002 Deconstructor", DKP_10N = 130, DKP_10H = 0, DKP_25N = 270, DKP_25H = 380 },
    { name = "The Assembly of Iron", DKP_10N = 130, DKP_10H = 0, DKP_25N = 270, DKP_25H = 380 },
    { name = "Kologarn", DKP_10N = 130, DKP_10H = 0, DKP_25N = 270, DKP_25H = 0 },
    { name = "Auriaya", DKP_10N = 130, DKP_10H = 0, DKP_25N = 270, DKP_25H = 0 },
    { name = "Hodir", DKP_10N = 130, DKP_10H = 0, DKP_25N = 270, DKP_25H = 380 },
    { name = "Thorim", DKP_10N = 130, DKP_10H = 0, DKP_25N = 270, DKP_25H = 380 },
    { name = "Freya", DKP_10N = 130, DKP_10H = 0, DKP_25N = 270, DKP_25H = 380 },
    { name = "Mimiron", DKP_10N = 130, DKP_10H = 0, DKP_25N = 270, DKP_25H = 380 },
    { name = "General Vezax", DKP_10N = 130, DKP_10H = 0, DKP_25N = 270, DKP_25H = 380 },
    { name = "Yogg-Saron", DKP_10N = 220, DKP_10H = 0, DKP_25N = 380, DKP_25H = 380 },
    { name = "Algalon the Observer", DKP_10N = 220, DKP_10H = 0, DKP_25N = 380, DKP_25H = 0 },
    ...
    { name = "Eydis Darkbane", DKP_10N = nil, DKP_10H = 100, DKP_25N = nil, DKP_25H = 200 },
